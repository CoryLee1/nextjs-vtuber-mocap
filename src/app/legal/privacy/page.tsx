  ...
  return (
    <div className="min-h-screen bg-black text-white p-8 md:p-16 font-sans">
      <div className="max-w-3xl mx-auto space-y-8">
        <h1 className="text-3xl font-bold text-[#B7FF7A]">Privacy Policy</h1>
        ...
        <section className="space-y-4">
          ...
          <p className="text-gray-300">
            If you have any questions about this Privacy Policy, please contact us at: <a href="mailto:cory@anngel.live" className="text-[#B7FF7A] hover:underline">cory@anngel.live</a>
          </p>
        </section>
      </div>
    </div>
